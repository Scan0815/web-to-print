...
| `config`                  | --                          | Validation rules for uploaded logos.                                                 | `LogoValidationConfig` | `{   minDpi: 300,   maxFileSize: 50 * 1024 * 1024, // 50MB   minWidth: 100,   minHeight: 100,   allowedFormats: ['png', 'jpeg', 'svg', 'tiff', 'avif'], }` |
